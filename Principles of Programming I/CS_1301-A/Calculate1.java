...
public class Calculate1{
   public static void main( String args[] ){
      ...
      System.out.printf ("\n%-50s","****************Output Report ****************");
      System.out.printf ("\n%-20s%-30s","Name:","Johnnie Oldfield");
      
      System.out.printf ("\n%-20s%-30s","Course:","CS1301A");
      System.out.printf ("\n%-20s%-30s","Date:","8/15/2017");
      System.out.printf ("\n%-50s","**********************************************");
      System.out.printf ("\n%-20s%30d","Number1", number1);
      System.out.printf ("\n%-20s%30d","Number2", number2); 
      System.out.printf ("\n%-20s%30d","Sum", sum);
      System.out.printf ("\n%-20s%30d","Difference", difference);
      System.out.printf ("\n%-20s%30d","Product", product);
      System.out.printf ("\n%-20s%30.2f","Division", division);
      System.out.printf ("\n%-20s%30.2f","Exponent", exponent);
      System.out.printf ("\n%-20s%30d","Remainder", remainder);
      System.out.printf ("\n%-20s%30.2f","Average", average);
      System.out.printf ("\n%-50s","**************** Have a good day *************");
